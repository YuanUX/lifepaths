                          {unifiedMilestones.map((m, idx) => {
                            ...
                            if (isNearToday) {
                              if (isLeftOfToday) {
                                transformStyle = 'translateX(-100%) translateX(-8px)'; // Move label to left of diamond with padding
                              } else {
                                transformStyle = 'translateX(8px)'; // Move label to right of diamond with padding
                              }
                            }
